...
val SENDT_TIL_AG_UPDATE_COUNTER: Counter = Counter.build()
    .name("sendt_update_counter")
    .namespace(METRICS_NS)
    .help("Antall endrede sendt til arbeidsgiver")
    .register()

val SIST_OPPDATERT_UPDATE_COUNTER: Counter = Counter.build()
    .name("sist_oppd_update_counter")
    .namespace(METRICS_NS)
    .help("Antall endrede sist oppdatert")
    .register()
