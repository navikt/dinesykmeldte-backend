...
import no.nav.syfo.sykmelding.model.sykmelding.arbeidsgiver.ArbeidsgiverAGDTO
...
import no.nav.syfo.sykmelding.model.sykmelding.arbeidsgiver.KontaktMedPasientAGDTO
import no.nav.syfo.sykmelding.model.sykmelding.arbeidsgiver.SykmeldingsperiodeAGDTO
import no.nav.syfo.sykmelding.model.sykmelding.arbeidsgiver.UtenlandskSykmeldingAGDTO
...
fun createSykmeldingDbModel(
    ...
    latestTom: LocalDate = LocalDate.now().minusWeeks(2),
    sendtTilArbeidsgiverDato: OffsetDateTime? = OffsetDateTime.now(ZoneOffset.UTC),
    land: String? = null,
    sykmelding: ArbeidsgiverSykmelding = createArbeidsgiverSykmelding(sykmeldingId = sykmeldingId, land = land),
): SykmeldingDbModel {
