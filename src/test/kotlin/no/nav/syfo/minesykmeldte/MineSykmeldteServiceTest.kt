    ...
    FunSpec(
            {
                ...
                val mineSykmeldtService =
                        MineSykmeldteService(mineSykmeldteDb, kafkaProducer, "topic")
                ...
                context("getMineSykmeldte") {
                    ...
                    test("should get one sykmeldt") {
                        ...
                        runBlocking {
                            ...
                            val periode =
                                    mineSykmeldte.first().sykmeldinger.first().perioder.first()
                    ...
                    test("Should get one sykmeldt with one IKKE_SENDT_SOKNAD") {
                        ...
                        runBlocking {
                            val mineSykmeldte = mineSykmeldtService.getMineSykmeldte("1")
                            mineSykmeldte.size shouldBeEqualTo 1
                            mineSykmeldte.first().sykmeldinger.first().perioder.first().type shouldBeEqualTo
                    ...
                    context("when mapping søknader") {
                            ...
                            coEvery { mineSykmeldteDb.getMineSykmeldte("1") } returns
                                    listOf(
                                            MinSykmeldtDbModel(
                                                    ...
                                                    lestSoknad = false,
                                                    sendtTilArbeidsgiverDato = OffsetDateTime.now(
                                                            ZoneOffset.UTC
                                                    ),
                                                    egenmeldingsdager =
                                                            listOf(
                        ...
                        test("Should not get Korrigert soknad") {
                            ...
                            val mineSykmeldte =
                                    runBlocking { mineSykmeldtService.getMineSykmeldte("1") }
                            mineSykmeldte.size shouldBeEqualTo 1
                ...
                context("getSoknad") {
                    test("should map correct") {
                        ...
                        coEvery {
                            mineSykmeldteDb.getSoknad(
                                    soknadDbModel.soknadId,
                                    "red-2"
                            )
                        } returns
                        ...
                        coEvery { mineSykmeldteDb.getSoknad(soknadId, "red-2") } returns
                                (createSykmeldtDbModel(
                                        ...
                                        createSoknadDbModel(
                                                ...
                                                soknad =
                                                        mockk<Soknad>().also {
                                                            every { it.fom } returns LocalDate.parse(
                                                                    "2021-10-01"
                                                            )
